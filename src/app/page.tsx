'use client'
import { ButtonLink, Footer, Heading, Navbar, SectionDescription, StepCard } from '@/components'
...
export default function Home() {
  return (
    <main className="w-full h-full gap-16 flex flex-col">
      ...
      {/* Hero Section */}
      <section className='flex flex-col md:flex-row items-center md:max-w-5xl mx-auto pt-32 gap-5 px-5 md:px-0'>
      ...
      {/* Steps Section */}
      <section className='flex flex-col gap-10 max-w-5xl mx-auto mt-10 items-center'>
        <Heading subHeading='Fast Solutions' heading='Step by step to get your health and mental care' isCentered={true} />
      ...
      {/* Schedule Section */}
      <section className="flex flex-col md:flex-row items-center max-w-5xl mx-auto mt-10 gap-10 px-5 md:px-0">
